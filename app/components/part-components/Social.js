...
export function Social() {
  ...
  $div.classList.add("contact", "column", "column--50");
  ...
  $div.innerHTML = `
        ...
        <p class="column__text"><i class="fas fa-phone"></i> Télefono: 999-999-999</p>
        <p class="column__text"><i class="fas fa-map-marker-alt"></i> Mainer 176, Monte Grande, Buenos Aires</p>
        <p class="column__text"><i class="fas fa-envelope"></i> consultas@yourrestaurant.com</p>
